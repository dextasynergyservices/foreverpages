...
const TributeSection = () => {
  ...
  const familyAccountDetails = {
    bankName: "Chase Bank",
    accountName: "Sarah Anderson Family Memorial Fund",
    accountNumber: "1234 5678 9012 3456",
    routingNumber: "021000021",
    paypal: "sarah.anderson@email.com",
    venmo: "@Sarah-Anderson-Memorial",
    zelle: "sarah.anderson@email.com",
  };
