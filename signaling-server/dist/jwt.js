...
function verifyAccessToken(token) {
    ...
    for (const pk of publicKeys) {
        try {
            const decoded = jsonwebtoken_1.default.verify(token, pk, { algorithms: ["RS256"] });
    ...
    const allowFallback = String(process.env.ALLOW_HS256_FALLBACK || "false").toLowerCase() === "true";
