...
async function main() {
  ...
  const notifications = [
    // 1. NEW_TRIBUTE - Recent & Unread
    {
      ...
      link: "/john-doe-memorial#tributes-section",
      isRead: false,
    ...
    // 2. NEW_TRIBUTE - Older & Read
    {
      ...
      link: "/john-doe-memorial#tribute-trib_456",
      isRead: true,
      readAt: hoursAgo(25),
      createdAt: daysAgo(2),
      userId: user.id,
    ...
    // 3. NEW_COMMENT - Recent & Unread
    {
      ...
      link: "/john-doe-memorial#comment-456",
      isRead: false,
    ...
    // 4. NEW_PHOTO - Recent & Unread
    {
      ...
      link: "/john-doe-memorial#gallery-section",
      isRead: false,
    ...
    // 5. NEW_CANDLE - Recent & Unread
    {
      ...
      link: "/john-doe-memorial#candles-section",
      isRead: false,
    ...
    // 6. NEW_FLOWER - Read
    {
      ...
      link: "/john-doe-memorial#flowers-section",
      isRead: true,
      readAt: daysAgo(1),
      createdAt: daysAgo(1),
      userId: user.id,
    ...
    // 7. INVITATION - Recent & Unread (High Priority)
    {
      ...
      link: "/user-dashboard?section=invitations&highlight=inv_789",
      isRead: false,
    ...
    // 8. MEMORIAL_ANNIVERSARY - Recent & Unread (Important)
    {
      ...
      link: "/john-doe-memorial#anniversary-tribute",
      isRead: false,
    ...
    // 9. BIRTHDAY_ANNIVERSARY - Older & Read
    {
      ...
      link: "/john-doe-memorial#birthday-memories",
      isRead: true,
      readAt: daysAgo(3),
      createdAt: daysAgo(3),
      userId: user.id,
    ...
    // 12. Additional NEW_COMMENT - for testing multiple unread
    {
      ...
      link: "/john-doe-memorial#comment-789",
      isRead: false,
    ...
    // 13. Additional NEW_PHOTO - for testing grouping
    {
      ...
      link: "/john-doe-memorial#photo-gallery-new",
      isRead: false,
