              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                  <div>
                    ...
                    <Input
                      ...
                      className="bg-white text-amber-100 placeholder-amber-100/50 backdrop-blur-sm"
                ...
                <div>
                  ...
                  <Textarea
                    ...
                    className="bg-white text-amber-100 placeholder-amber-100/50 backdrop-blur-sm min-h-[100px] md:min-h-[120px] text-sm md:text-base"
                ...
                <Button
                  ...
                  className={`w-full ${getOfferingButtonColor(newTribute.offering)} text-amber-100 font-body font-semibold py-4 md:py-6 text-base md:text-lg transition-all duration-300 hover:scale-105 shadow-2xl backdrop-blur-sm border`}
                >
                  {isSubmitting ? (
                    <>
        ...
        >
          ...
          >
            ...
            <div className="flex items-center justify-center p-4 md:p-6 border-t border-amber-300/20">
              <Button
                className={`${getOfferingButtonColor(selectedTribute.offering)} text-amber-100 border`}
              >
