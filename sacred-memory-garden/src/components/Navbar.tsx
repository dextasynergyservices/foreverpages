...
const Navbar = ({ onSendBlessing }: NavbarProps) => {
        ...
        <div className="container mx-auto px-4">
          ...
          <div className="hidden md:flex items-center justify-center gap-6 lg:gap-8">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-500 hover:to-amber-600 border border-amber-400 text-amber-100 font-body font-semibold px-6 shadow-[0_0_20px_rgba(251,191,36,0.4)] transition-all duration-300 hover:scale-105"
            >
              Send Blessing
            </Button>
          </div>
            ...
            <div className="p-6 bg-[#1f2615]">
              ...
              <div className="mt-8 pt-6 border-t border-amber-300/30">
                <Button
                  ...
                  className="w-full bg-gradient-to-r from-amber-600 to-amber-700 hover:from-amber-500 hover:to-amber-600 border border-amber-400 text-amber-100 font-body font-semibold py-4 shadow-[0_0_20px_rgba(251,191,36,0.4)] transition-all duration-300 hover:scale-105"
                >
                  Send Blessing
                </Button>
              </div>
