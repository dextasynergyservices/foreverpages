...
import { Send, Loader2, Mail, Phone, MapPin, Clock, CheckCircle } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok && data.success) {
        ...
        toast.error(
          data.error || t("contact.error") || "Failed to send message. Please try again."
        );
      }
    } catch (error) {
      console.error("Contact form error:", error);
      toast.error(
        t("contact.networkError") || "Network error. Please check your connection and try again."
      );
    } finally {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {isSubmitted ? (
              <div
                className={cn(
                  "p-8 rounded-lg border transition-colors duration-300 text-center",
                  theme === "dark" ? "border-white/30 bg-black/50" : "border-gray-300 bg-gray-50"
                )}
              >
                <div
                ...
                <Button
                  ...
                  className={cn(
                    "px-8 py-3 font-semibold transition-all duration-300 border backdrop-blur-sm",
                    theme === "dark"
