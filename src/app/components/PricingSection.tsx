...
export const PricingSection: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // Also update the circle creation to use relative positioning:
    if (Math.random() < 0.2) {
      circles.push({
    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto w-full">
        <div className="text-center mb-12 sm:mb-16">
          ...
          >
            Choose the plan that&apos;s right for your family&apos;s needs
          </p>
        </div>
        ...
        >
          ...
          >
            Free setup assistance, 24/7 customer support, and the peace of mind that your memorial
