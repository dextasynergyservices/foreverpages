              ...
              <div className="space-y-4 md:space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-3 md:gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-white/5 border border-white/20 text-amber-100 placeholder-amber-100/50 backdrop-blur-sm rounded-md px-3 py-2"
                ...
                <div>
                  ...
                  <textarea
                    ...
                    onChange={(e) =>
                      setNewCondolence({ ...newCondolence, message: e.target.value })
                    }
                    className="w-full bg-white/5 border border-white/20 text-amber-100 placeholder-amber-100/50 backdrop-blur-sm min-h-[100px] md:min-h-[120px] text-sm md:text-base rounded-md px-3 py-2"
              ...
              {totalPages > 1 && (
                <div className="flex items-center justify-center space-x-2 pt-4">
                  <button
                    ...
                    className="bg-white/5 border border-white/20 text-amber-100 hover:bg-white/10 disabled:opacity-50 disabled:cursor-not-allowed rounded-md p-2"
                  >
                    ...
                    {Array.from({ length: totalPages }, (_, i) => i + 1).map((page) => (
                      <button
                        ...
                        className={`px-3 py-1 rounded-md text-sm ${
                          currentPage === page
                            ? "bg-amber-600/50 border border-amber-400/30 text-amber-100"
                            : "bg-white/5 border border-white/20 text-amber-100 hover:bg-white/10"
                        }`}
                      >
                        {page}
                      </button>
        ...
        >
          ...
          >
                  ...
                  {selectedCondolence.letter.startsWith("data:image/") ? (
                    ...
                    <div className="p-8 text-center">
                      ...
                      <button
                        ...
                        className="bg-amber-600/30 hover:bg-amber-600/40 border border-amber-400/30 text-amber-100 rounded-md px-4 py-2 flex items-center"
                      >
            ...
            <div className="flex items-center justify-center p-4 md:p-6 border-t border-amber-300/20">
              <button className="bg-amber-600/30 hover:bg-amber-600/40 border border-amber-400/30 text-amber-100 rounded-md px-4 py-2 flex items-center">
