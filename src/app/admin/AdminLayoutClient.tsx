        ...
        >
          <div className="flex h-full flex-col">
            ...
            <nav className="flex-1 space-y-1 overflow-y-auto p-4">
              ...
              <div className="pt-4">
                <div
                  className={`px-3 py-2 text-xs font-semibold text-gray-500 uppercase tracking-wider ${sidebarCollapsed ? "lg:hidden" : ""}`}
                >
                  Templates
                </div>
              </div>
              ...
              <NavLink
                href="/admin/templates/templates"
                icon={<Palette className="h-5 w-5" />}
                active={pathname === "/admin/templates/templates"}
                collapsed={sidebarCollapsed}
              >
                Templates
              </NavLink>
              <NavLink
                href="/admin/templates/management"
                icon={<Edit className="h-5 w-5" />}
                active={pathname === "/admin/templates/management"}
                collapsed={sidebarCollapsed}
              >
              ...
              <NavLink
                ...
                icon={<LayoutDashboard className="h-5 w-5" />}
                active={pathname === "/admin/templates/categories"}
                collapsed={sidebarCollapsed}
              >
                Categories
              </NavLink>
              <NavLink
                ...
                icon={<Settings className="h-5 w-5" />}
                active={pathname === "/admin/templates/builder"}
                collapsed={sidebarCollapsed}
              >
                Template Builder
              </NavLink>
